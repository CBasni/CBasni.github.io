...
function preload() {
  spelunky2 = loadImage("media/spelunky2.png");
}
...
function setup() {
  ...
  character.addAnimation("down", new SpriteAnimation(spelunky2, 6, 5, 6));
  character.addAnimation("up", new SpriteAnimation(spelunky2, 0, 5, 6));
  character.addAnimation("right", new SpriteAnimation(spelunky2, 0, 0, 6));
  character.addAnimation("left", new SpriteAnimation(spelunky2, 0, 0, 6, true)); 
  character.addAnimation("stand_right", new SpriteAnimation(spelunky2, 0, 0, 1)); 
  character.addAnimation("stand_left", new SpriteAnimation(spelunky2, 0, 0, 1, true)); 
